package com.sabre.tripcase.tcp.nlp;
...
import com.sabre.tripcase.tcp.gate.GateContentParser;
import com.sabre.tripcase.tcp.gate.GateContentParser.SortedAnnotationList;
 ...
 *
 */
public class NLPContentParser implements InitializingBean {
	...
	private void getAnnotationResult(Exchange exchange){
		...
		while (iter.hasNext()) 
		{
			...
			map.put("NLP", annotationList);
			exchange.getIn().setBody(map);
			//System.out.println("nlp done"+map);
